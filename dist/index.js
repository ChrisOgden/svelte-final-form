(function (global, factory) {
  ...
  function create_if_block(ctx) {
  	let current;
  	const default_slot_template = /*#slots*/ ctx[9].default;
  	const default_slot = internal.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[12], get_default_slot_context$2);
  	...
  	return {
  		...
  		p(ctx, dirty) {
  			if (default_slot) {
  				if (default_slot.p && dirty & /*$$scope, field*/ 4100) {
  					internal.update_slot(default_slot, default_slot_template, ctx, /*$$scope*/ ctx[12], dirty, get_default_slot_changes$2, get_default_slot_context$2);
  				}
  			} else {
  ...
  function create_if_block_2(ctx) {
  	...
  	return {
  		...
  		p(new_ctx, dirty) {
  			...
  			if (dirty & /*input, $$restProps*/ 72 && select_data.multiple) internal.select_options(select, select_data.value);
  		},
  		i(local) {
  			if (current) return;
  			internal.transition_in(default_slot, local);
